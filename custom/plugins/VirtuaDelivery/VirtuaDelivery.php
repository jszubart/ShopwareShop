...
/**
 * Shopware-Plugin VirtuaDelivery.
 */
class VirtuaDelivery extends Plugin
{
    /**
    ...
    */
    ...
    {
        $container->setParameter('virtua_delivery.plugin_dir', $this->getPath());
    ...
    private function createSchema()
    {
        ...
        $classes = [
            $this->container->get('models')->getClassMetadata(\VirtuaDelivery\Models\Delivery::class)
        ];
