...
namespace TechnologyPlugin\Models;
...
class Repository extends ModelRepository
{
    ...
    /**
     * Returns an instance of the \Doctrine\ORM\Query object which selects a list of Technology
     *
     * @param null $filter
     * @param null $orderBy
     * @param      $offset
    ...
    public function getListQueryBuilder($filter = null, $orderBy = null)
    {
        ...
        $builder->select(array('technology'))
            ->from($this->getEntityName(), 'technology');
